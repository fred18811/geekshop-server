...
from admins.views import index, UserListView, UserCreateView, UserUpdateView, UserDeleteView, ProdactListView, ProdactCreateView, ProdactUpdateView, ProdactDeleteView
